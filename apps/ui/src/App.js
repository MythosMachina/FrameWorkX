...
const nav = ["dashboard", "pipeline", "generator", "gallery", "lora", "messages"];
const adminTabs = [
    "queue",
    "core",
    "tagger",
...
function renderAvatar(fileId, authToken, altLabel) {
    ...
    if (!fileId) {
        return _jsx("span", { className: "tile-avatar-wrap placeholder", children: fallbackInitial });
    }
...
function getLoraRouteIdFromPathname(pathname) {
    const normalized = normalizePathname(pathname);
    const mobile = isMobileRoute(normalized);
    const withoutMobile = mobile ? normalized.replace(/^\/m(?=\/|$)/, "") || "/" : normalized;
...
export default function App() {
    ...
    const [loraRouteId, setLoraRouteId] = useState(typeof window !== "undefined" ? getLoraRouteIdFromPathname(window.location.pathname) : "");
    ...
    const selectedLoraPreviewWindow = useMemo(() => {
        if (!selectedLoraPreviewIds.length)
            return [];
        if (selectedLoraPreviewIds.length <= 2)
            return selectedLoraPreviewIds;
    ...
    const loraDetailActive = Boolean(view === "lora" && selectedLoraEntry && loraRouteId && selectedLoraEntry.id === loraRouteId);
    ...
    useEffect(() => {
        if (!token || view !== "lora" || !loraRouteId)
            return;
        if (selectedLoraEntry?.id === loraRouteId)
            return;
    ...
    const applyLoraEntryPatch = (loraId, patch) => {
    ...
    return (_jsxs("div", { className: `app-shell ${isMobileRouteActive ? "mobile-route" : ""}`, children: [isMobileRouteActive ? (_jsxs(_Fragment, { children: [_jsxs("header", { className: "mobile-topbar", children: [_jsxs("div", { className: "mobile-topbar-brand", children: [_jsx("div", { className: "brand-title", children: "FrameWorkX" }), _jsx("div", { className: "brand-subtitle", children: "Mobile Console" })] }), _jsxs("div", { className: "mobile-topbar-actions", children: [_jsxs("button", { type: "button", className: "action-btn ghost mobile-notify-btn", onClick: () => setNotificationWidgetOpen((prev) => !prev), children: ["\uD83D\uDD14", notificationUnread > 0 ? _jsx("span", { className: "notify-count", children: notificationUnread }) : null] }), _jsx("button", { type: "button", className: "action-btn mobile-menu-btn", onClick: () => {
                                    ...
                                    .map((item) => (_jsxs("button", { className: `notify-item ${item.read_at ? "is-read" : "is-unread"}`, onClick: () => {
                                        ...
                                        return (_jsx("button", { type: "button", className: `mobile-nav-btn ${view === key ? "is-active" : ""}`, disabled: locked, onClick: () => setView(key), children: t[key] }, `mobile-${key}`));
                                            ...
                                            setView("admin");
                                            setAdminTab("queue");
                                        }, children: "Admin Settings" })) : null] }), _jsx("div", { className: "mobile-drawer-foot", children: _jsxs("div", { className: "lang-switch", children: [_jsx("button", { type: "button", onClick: () => setLang("en"), children: "EN" }), _jsx("button", { type: "button", onClick: () => setLang("de"), children: "DE" })] }) })] })) : null] })) : null, _jsxs("aside", { className: "rail", children: [_jsx("div", { className: "brand", children: _jsx("div", { className: "logo", children: _jsx("img", { src: "/logo.png", alt: "FrameWorkX logo", loading: "eager", decoding: "async" }) }) }), _jsx("nav", { className: "rail-nav", children: nav.map((key) => {
                            const locked = (key === "generator" && !canGenerate) || (key === "pipeline" && !canTrain);
                            return (_jsx("button", { className: `rail-btn ${view === key ? "is-active" : ""} ${locked ? "is-disabled" : ""}`, onClick: () => {
                                    ...
                                    setView(key);
                                            ...
                                            setAdminTab("queue");
                                                ...
                                                openGalleryImage(img.id);
                                                                    ...
                                                                    }, children: ["@", img.username, img.is_public ? " • Public" : ""] })] }), _jsxs("span", { className: "tile-meta-stats", children: [_jsxs("span", { children: ["\u2665 ", img.like_count ?? 0] }), _jsxs("span", { children: ["\uD83D\uDCAC ", img.comment_count ?? 0] })] })] })] }, img.id))) })] }), _jsxs("section", { className: `view ${view === "lora" ? "is-active" : ""}`, children: [_jsxs("div", { className: "view-header", children: [_jsx("h1", { children: loraDetailActive ? selectedLoraEntry?.name ?? t.lora : t.lora }), _jsxs("div", { className: "gallery-header", children: [_jsx("p", { children: loraDetailActive
                                                            ? "Model detail"
                                                            : loraMode === "private"
                                                                ? "Private gallery"
                                                                : "Public feed" }), _jsxs("div", { className: "gallery-actions", children: [loraDetailActive ? (_jsx("button", { className: "action-btn ghost", onClick: () => {
                                                                    setLoraRouteId("");
                                                                    setSelectedLoraEntry(null);
                                                                    setSelectedLoraPreview(null);
                                                                }, children: "Back to list" })) : null, loraDetailActive && selectedLoraEntry && (selectedLoraEntry.user_id === user?.id || user?.role === "admin") ? (_jsx("button", { className: "action-btn icon-danger-btn", title: ["queued", "processing"].includes(String(selectedLoraEntry.remove_status ?? ""))
                                                                    ? "Delete already queued"
                                                                    : "Delete model", disabled: ["queued", "processing"].includes(String(selectedLoraEntry.remove_status ?? "")), onClick: () => {
                                                                    if (!token)
                                                                        return;
                                                                ...
                                                                }, children: "\u24E7" })) : null, !loraDetailActive && loraMode === "private" ? (_jsx("button", { className: "action-btn ghost", onClick: () => setLoraUploadOpen(true), children: "Upload LoRA" })) : null, !loraDetailActive && token ? (_jsx("button", { className: "action-btn ghost", onClick: () => {
                                                                    setLoraBulkMode((prev) => !prev);
                                                                    setLoraBulkSelection([]);
                                                                    setLoraBulkMessage("");
                                                                }, children: loraBulkMode ? "Cancel Bulk Action" : "Bulk Action" })) : null, !loraDetailActive ? (_jsx("button", { className: "action-btn ghost", onClick: () => setLoraMode((prev) => (prev === "public" ? "private" : "public")), children: loraMode === "public" ? "Private gallery" : "Public feed" })) : null] })] })] }), !loraDetailActive && loraBulkMode ? (_jsxs("div", { className: "bulk-gallery-bar", children: [_jsxs("span", { className: "muted small", children: [loraBulkSelection.length, " selected"] }), _jsx("button", { className: "action-btn ghost", disabled: loraBulkBusy || manageableVisibleLoraIds.length === 0, onClick: () => setLoraBulkSelection(manageableVisibleLoraIds), children: "Select all" }), _jsx("button", { className: "action-btn ghost", disabled: loraBulkBusy || loraBulkSelection.length === 0, onClick: () => setLoraBulkSelection([]), children: "Clear" }), _jsx("button", { className: "action-btn ghost", disabled: loraBulkBusy || loraBulkSelection.length === 0, onClick: generateLoraBulkPreviews, children: "Generate previews" }), _jsx("button", { className: "action-btn ghost", disabled: loraBulkBusy || loraBulkSelection.length === 0, onClick: () => applyLoraBulkVisibility(true), children: "Set Public" }), _jsx("button", { className: "action-btn ghost", disabled: loraBulkBusy || loraBulkSelection.length === 0, onClick: () => applyLoraBulkVisibility(false), children: "Set Private" }), _jsx("button", { className: "action-btn danger", disabled: loraBulkBusy || loraBulkSelection.length === 0, onClick: deleteLoraBulkSelection, children: "Delete Selected" }), loraBulkMessage ? _jsx("span", { className: "muted small", children: loraBulkMessage }) : null] })) : null, !loraDetailActive ? _jsxs("div", { className: "lora-grid", children: [loraEntries.map((entry) => (_jsxs("button", { className: `lora-card ${loraBulkMode && canManageLoraEntry(entry) ? "is-selectable" : ""} ${loraBulkSelection.includes(entry.id) ? "is-selected" : ""}`, onClick: () => {
                                                    ...
                                                    openLoraEntry(entry);
                                                            ...
                                                            : entry.remove_status === "processing"
                                                                ...
                                                                }, children: ["@", entry.username, entry.source === "external" ? " • External" : ""] }), _jsxs("span", { className: "tile-meta-stats", children: [_jsxs("span", { children: ["\u2665 ", entry.like_count ?? 0] }), _jsxs("span", { children: ["\uD83D\uDCAC ", entry.comment_count ?? 0] })] })] }), loraPreviewStatus[entry.id] ? (_jsx("div", { className: "muted small", children: loraPreviewStatus[entry.id] })) : null] }, entry.id))), !loraEntries.length ? _jsx("div", { className: "muted small", children: "No LoRA entries yet." }) : null] }) : null, loraDetailActive && selectedLoraEntry ? (_jsxs("div", { className: "lora-detail-page panel", children: [_jsxs("div", { className: "lora-detail-main", children: [_jsxs("div", { className: "lora-detail-stats", children: [_jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Likes" }), _jsx("div", { className: "value", children: selectedLoraMeta?.likes ?? selectedLoraEntry.like_count ?? 0 })] }), _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Downloads" }), _jsx("div", { className: "value", children: selectedLoraEntry.download_count ?? "—" })] }), _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Generated" }), _jsx("div", { className: "value", children: selectedLoraEntry.generated_count ?? "—" })] }), _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Favorite" }), _jsx("div", { className: "value", children: selectedLoraEntry.favorite_count ?? "planned" })] })] }), _jsxs("div", { className: "lora-preview-stage", children: [_jsx("button", { className: "lora-stage-nav", onClick: () => setLoraDetailPreviewOffset((prev) => prev - 1), disabled: selectedLoraPreviewIds.length <= 2, children: "\u25C0" }), _jsxs("div", { className: "lora-previews large two-up", children: [selectedLoraPreviewWindow.map((fileId) => (_jsx("button", { className: "preview-tile", onClick: () => setSelectedLoraPreview(fileId), children: _jsx("img", { src: withToken(`/api/files/${fileId}`, token), alt: `${selectedLoraEntry.name} preview` }) }, fileId))), !selectedLoraPreviewIds.length ? _jsx("div", { className: "muted small", children: "No previews yet." }) : null] }), _jsx("button", { className: "lora-stage-nav", onClick: () => setLoraDetailPreviewOffset((prev) => prev + 1), disabled: selectedLoraPreviewIds.length <= 2, children: "\u25B6" })] }), _jsxs("div", { className: "model-description", children: [_jsxs("div", { className: "stat-row", children: [_jsx("span", { children: "Description" }), _jsx("span", {})] }), _jsx("div", { className: "muted small", children: selectedLoraEntry.description?.trim() ? selectedLoraEntry.description : "—" })] })] }), _jsxs("aside", { className: "lora-detail-side", children: [_jsx("div", { className: "modal-actions lora-actions lora-actions--social", children: _jsxs("button", { className: "action-btn", onClick: () => {
                                                                ...
                                                                (selectedLoraEntry.user_id === user?.id || user?.role === "admin") ? (_jsx("a", { className: "action-btn ghost", href: fileUrl(selectedLoraEntry.dataset_file_id, token), target: "_blank", rel: "noreferrer", children: "Download dataset" })) : null] }), selectedLoraEntry.user_id === user?.id || user?.role === "admin" ? (_jsxs("div", { className: "panel lora-detail-files", children: [_jsx("div", { className: "detail-title", children: "Model edit" }), loraDetailEditing ? (_jsxs("div", { className: "description-edit", children: [_jsx("input", { className: "input", value: loraNameDraft, onChange: (e) => setLoraNameDraft(e.target.value), placeholder: "Model name" }), _jsx("textarea", { className: "input", rows: 3, value: loraDescriptionDraft, onChange: (e) => setLoraDescriptionDraft(e.target.value), placeholder: "Model description" }), _jsx("input", { className: "input", value: loraTriggerDraft, onChange: (e) => setLoraTriggerDraft(e.target.value), placeholder: "Trigger / Activator token" }), _jsxs("div", { className: "wizard-actions", children: [_jsx("button", { className: "action-btn ghost", onClick: () => {
                                                            ...
                                                            return (_jsx("button", { className: `dm-thread-item ${selected ? "is-active" : ""}`, onClick: () => setDmActiveThreadId(thread.id), children: _jsxs("div", { className: "dm-thread-top", children: [_jsx("span", { className: "dm-thread-name", children: thread.peer_display_name || thread.peer_username }), thread.unread_count ? _jsx("span", { className: "badge", children: thread.unread_count }) : null] }) }, thread.id));
                                                                ...
                                                                return (_jsx("div", { className: `dm-bubble-row ${mine ? "is-mine" : "is-peer"}`, children: _jsxs("div", { className: `dm-bubble ${mine ? "is-mine" : "is-peer"}`, children: [_jsx("div", { className: "dm-bubble-text", children: message.body }), _jsx("div", { className: "dm-bubble-time", children: new Date(message.created_at).toLocaleTimeString() })] }) }, message.id));
                                                                        ...
                                                                        } })] }), avatarStatus ? _jsx("div", { className: "muted small", children: avatarStatus }) : null] }), _jsxs("div", { className: "job-actions", children: [_jsx("button", { className: "action-btn", onClick: () => {
                                ...
                                refreshDmUnread();
                                                ...
                                                xhr.send(form);
                                            }, children: "Upload to gallery" }), loraUploadStatus ? _jsx("div", { className: "muted small", children: loraUploadStatus }) : null, loraUploadStatus === "Uploading..." ? (_jsx("div", { className: "progress", children: _jsx("span", { style: { width: `${loraUploadProgress}%` } }) })) : null] })) : (_jsx("div", { className: "muted small", children: "LoRA upload permission required." }))] }) })) : null, view === "lora" && selectedLoraEntry && !loraDetailActive ? (_jsx("div", { className: "image-modal", children: _jsxs("div", { className: "image-modal-content", children: [_jsx("button", { className: "modal-close", onClick: () => {
                                        setSelectedLoraEntry(null);
                                        setSelectedLoraPreview(null);
                                    }, children: "Close" }), _jsxs("div", { className: "modal-body", children: [_jsxs("div", { className: "modal-image", children: [_jsxs("div", { className: "lora-preview-stage", children: [_jsx("button", { className: "lora-stage-nav", onClick: () => setLoraDetailPreviewOffset((prev) => prev - 1), disabled: selectedLoraPreviewIds.length <= 2, children: "\u25C0" }), _jsxs("div", { className: "lora-previews large two-up", children: [selectedLoraPreviewWindow.map((fileId) => (_jsx("button", { className: "preview-tile", onClick: () => setSelectedLoraPreview(fileId), children: _jsx("img", { src: withToken(`/api/files/${fileId}`, token), alt: `${selectedLoraEntry.name} preview` }) }, fileId))), !selectedLoraPreviewIds.length ? _jsx("div", { className: "muted small", children: "No previews yet." }) : null] }), _jsx("button", { className: "lora-stage-nav", onClick: () => setLoraDetailPreviewOffset((prev) => prev + 1), disabled: selectedLoraPreviewIds.length <= 2, children: "\u25B6" })] }), _jsx("div", { className: "lora-stage-caption muted small", children: selectedLoraEntry.description?.trim() || "No description yet." })] }), _jsxs("div", { className: "modal-info", children: [_jsxs("div", { className: "panel-header", children: [_jsx("h3", { children: selectedLoraEntry.name }), _jsxs("span", { className: "badge", children: ["@", selectedLoraEntry.username] })] }), _jsxs("div", { className: "lora-detail-stats", children: [_jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Likes" }), _jsx("div", { className: "value", children: selectedLoraMeta?.likes ?? selectedLoraEntry.like_count ?? 0 })] }), _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Downloads" }), _jsx("div", { className: "value", children: selectedLoraEntry.download_count ?? "—" })] }), _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Generated" }), _jsx("div", { className: "value", children: selectedLoraEntry.generated_count ?? "—" })] }), _jsxs("div", { className: "stat-card", children: [_jsx("div", { className: "label", children: "Favorite" }), _jsx("div", { className: "value", children: "planned" })] })] }), _jsxs("div", { className: "model-description", children: [_jsxs("div", { className: "stat-row", children: [_jsx("span", { children: "Description" }), _jsx("span", {})] }), selectedLoraEntry.user_id === user?.id || user?.role === "admin" ? (loraDescriptionEditing ? (_jsxs("div", { className: "description-edit", children: [_jsx("textarea", { className: "input", rows: 3, value: loraDescriptionDraft, onChange: (e) => setLoraDescriptionDraft(e.target.value), placeholder: "Add a short description for this model." }), _jsxs("div", { className: "wizard-actions", children: [_jsx("button", { className: "action-btn ghost", onClick: () => {
                                                                                setLoraDescriptionDraft(selectedLoraEntry.description ?? "");
                                                                                setLoraDescriptionEditing(false);
                                                                                setLoraDescriptionStatus("");
                                                                            }, children: "Cancel" }), _jsx("button", { className: "action-btn", onClick: () => {
